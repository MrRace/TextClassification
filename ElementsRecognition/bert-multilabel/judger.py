...
class Judger:
    ...
    def test(self, truth_path, output_path):
        cnt = 0
        result = [[]]
        for a in range(0, self.task_cnt):# 每一类都构建一个对应的TP,FP，TN和FN
...
if __name__ == '__main__':
    labor_raw_data_base_dir = "/home/liujiepeng/MachineComprehension/CAIL2019/ElementsRecognition/data/CAIL2019-FE-big/labor"
    truth_path_labor = os.path.join("/home/liujiepeng/MachineComprehension/CAIL2019/ElementsRecognition/bert_tensorflow_multi_label/data/labor", "test.json")
    labor_tag_file = os.path.join(labor_raw_data_base_dir, "tags.txt")
    loan_raw_data_base_dir = "/home/liujiepeng/MachineComprehension/CAIL2019/ElementsRecognition/data/CAIL2019-FE-big/loan"
    truth_path_loan = os.path.join("/home/liujiepeng/MachineComprehension/CAIL2019/ElementsRecognition/bert_tensorflow_multi_label/data/loan", "test.json")
    loan_tag_file = os.path.join(loan_raw_data_base_dir, "tags.txt")
    divorce_raw_data_base_dir = "/home/liujiepeng/MachineComprehension/CAIL2019/ElementsRecognition/data/CAIL2019-FE-big/divorce"
    truth_path_divorce = os.path.join("/home/liujiepeng/MachineComprehension/CAIL2019/ElementsRecognition/bert_tensorflow_multi_label/data/divorce", "test.json")
    divorce_tag_file = os.path.join(divorce_raw_data_base_dir, "tags.txt")
    final_score = get_score(truth_path_labor=truth_path_labor,
                            output_path_labor='../output/labor_output.json',
                            tag_path_labor=labor_tag_file,
                            truth_path_divorce=truth_path_divorce,
                            output_path_divorce='../output/divorce_output.json',
                            tag_path_divorce=divorce_tag_file,
                            truth_path_loan=truth_path_loan,
                            output_path_loan='../output/loan_output.json',
                            tag_path_loan=loan_tag_file)
    print(final_score)
