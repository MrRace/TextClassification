...
if __name__ == '__main__':
    ...
    loan_raw_data_base_dir = "/home/liujiepeng/MachineComprehension/CAIL2019/ElementsRecognition/data/CAIL2019-FE-big/labor"
    loan_tag_file = os.path.join(loan_raw_data_base_dir, "tags.txt")
    divorce_raw_data_base_dir = "/home/liujiepeng/MachineComprehension/CAIL2019/ElementsRecognition/data/CAIL2019-FE-big/labor"
    divorce_tag_file = os.path.join(divorce_raw_data_base_dir, "tags.txt")
    final_score = get_score(truth_path_labor='data/labor/test.json',
                            output_path_labor='./output/labor_output.json',
                            tag_path_labor=labor_tag_file,
                            truth_path_divorce='data/divorce/test.json',
                            output_path_divorce='./outputs/divorce_output.json',
                            tag_path_divorce=divorce_tag_file,
                            truth_path_loan='data/loan/test.json',
